...
public class Enemy : MonoBehaviour
{
    ...
    public void Init(GameObject player, params Transform[] movePoints)
    {
        _player = player;
    ...
    void FixedUpdate()
    {
        if (_isMove)
        {
            ...
            Vector3 newDir = Vector3.RotateTowards(transform.position, targetDir, Time.fixedDeltaTime * 50f, 0f);
